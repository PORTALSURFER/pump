...
5. [x] Pass default CI (223 tests), VST3 CI (250 tests), and four-size screenshot validation, including backward/forward seeks, empty blocks, all-silent blocks, and CLAP zero-frame/output-only input classification.
