...
5. [x] Pass default CI (221 tests), VST3 CI (248 tests), and four-size screenshot validation, including backward/forward seeks, empty blocks, and all-silent blocks.
