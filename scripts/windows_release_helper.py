#!/usr/bin/env python3
"""Build and validate Pump's unsigned Windows VST3 release artifact."""
...
SAFE_ARCHIVE_NAME = re.compile(
    r"^pump-v[0-9A-Za-z.-]+-windows-x86_64-unsigned\.vst3\.zip$"
)
...
def bundle_name(package_version: str) -> str:
    return f"Pump-v{package_version}.vst3"


def archive_name(publication_version: str) -> str:
    return f"pump-v{publication_version}-windows-x86_64-unsigned.vst3.zip"
